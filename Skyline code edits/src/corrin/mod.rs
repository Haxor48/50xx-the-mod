...
pub fn corrin_fair(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=9)
        if(is_excute){
...
pub fn corrin_uair(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=4)
        if(is_excute){
            WorkModule::on_flag(Flag=FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING)
...
pub fn corrin_nair(fighter: &mut L2CFighterCommon) {
    acmd!({
        if(is_excute){
...
pub fn corrin_bair(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=6)
        if(is_excute){
            WorkModule::on_flag(Flag=FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING)
...
pub fn corrin_dair(fighter: &mut L2CFighterCommon) {
    acmd!({
...
pub fn corrin_effect_dair(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=8)
        if(is_excute){
...
pub fn corrin_ftilt(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=8)
        if(is_excute){
...
pub fn corrin_utilt(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=7)
        if(is_excute){
...
pub fn corrin_dtilt(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=5)
        if(is_excute){
...
pub fn corrin_da(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=12)
        for(5 Iterations){
            if(is_excute){
...
pub fn corrin_usmash(fighter: &mut L2CFighterCommon) {
    acmd!({
        frame(Frame=10)
        if(is_excute){
...
pub fn corrin_dsmash(fighter: &mut L2CFighterCommon) {
    acmd!({
...
pub fn corrin_landing_dair(fighter: &mut L2CFighterCommon) {
    acmd!({
...
pub fn corrin_fsmash(fighter: &mut L2CFighterBase) {
    acmd!({
        if(is_excute){
...
pub fn corrin_sideb_grnd(fighter: &mut L2CFighterBase) {
    acmd!({
        if(is_excute){
            AttackModule::set_attack_reference_joint_id(Hash40{hash: hash40("drag1")}, smash::app::AttackDirectionAxis(*ATTACK_DIRECTION_X as i32), smash::app::AttackDirectionAxis(*ATTACK_DIRECTION_Z as i32), smash::app::AttackDirectionAxis(*ATTACK_DIRECTION_Y as i32))
        }
...
#[acmd_func(
    battle_object_category = BATTLE_OBJECT_CATEGORY_WEAPON, 
    battle_object_kind = WEAPON_KIND_KAMUI_SPEARHAND, 
    animation = "special_air_s_attack",
    animcmd = "game_specialairsattack")]
pub fn corrin_sideb_air(fighter: &mut L2CFighterBase) {
    acmd!({
        if(is_excute){
            AttackModule::set_attack_reference_joint_id(Hash40{hash: hash40("drag1")}, smash::app::AttackDirectionAxis(*ATTACK_DIRECTION_X as i32), smash::app::AttackDirectionAxis(*ATTACK_DIRECTION_Z as i32), smash::app::AttackDirectionAxis(*ATTACK_DIRECTION_Y as i32))
        }
