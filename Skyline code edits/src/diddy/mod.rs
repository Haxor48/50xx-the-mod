...
#[acmd_script(agent = "diddy", scripts = ["game_attackairhi"], category = ACMD_GAME)]
fn diddy_uair(fighter: &mut smash::lua2cpp::L2CAgentBase) {
...
#[acmd_script(agent = "diddy", scripts = ["game_attackairf"], category = ACMD_GAME)]
fn diddy_fair(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=3)
        if(is_excute){
...
#[acmd_script(agent = "diddy", scripts = ["game_attackairb"], category = ACMD_GAME)]
fn diddy_bair(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=3)
        if(is_excute){
...
#[acmd_script(agent = "diddy", scripts = ["game_attack13"], category = ACMD_GAME)]
fn diddy_jab3(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=5)
        if(is_excute){
...
#[acmd_script(agent = "diddy", scripts = ["game_attackhi3"], category = ACMD_GAME)]
fn diddy_utilt(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=6)
        if(is_excute){
...
#[acmd_script(agent = "diddy", scripts = ["game_attacklw3"], category = ACMD_GAME)]
fn diddy_dtilt(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=4)
        if(is_excute){
...
#[acmd_script(agent = "diddy", scripts = ["game_attacks3s", "game_attacks3hi", "game_attacks3lw"], category = ACMD_GAME)]
fn diddy_ftilt(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=9)
        if(is_excute){
...
#[acmd_script(agent = "diddy", scripts = ["game_attacks4s"], category = ACMD_GAME)]
fn diddy_fsmash(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=5)
        if(is_excute){
...
#[acmd_script(agent = "diddy", scripts = ["game_attackhi4"], category = ACMD_GAME)]
fn diddy_usmash(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=2)
        if(is_excute){
...
#[acmd_script(agent = "diddy", scripts = ["game_attacklw4"], category = ACMD_GAME)]
fn diddy_dsmash(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=3)
        if(is_excute){
...
#[acmd_script(agent = "diddy", scripts = ["game_attackairn"], category = ACMD_GAME)]
fn diddy_nair(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=4)
        if(is_excute){
...
#[acmd_script(agent = "diddy", scripts = ["game_catch"], category = ACMD_GAME)]
fn diddy_grab(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=6)
        if(is_excute){
...
#[acmd_script(agent = "diddy", scripts = ["game_catchdash"], category = ACMD_GAME)]
fn diddy_dashgrab(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=9)
        if(is_excute){
...
#[acmd_script(agent = "diddy", scripts = ["game_catchturn"], category = ACMD_GAME)]
fn diddy_pivotgrab(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=10)
        if(is_excute){
