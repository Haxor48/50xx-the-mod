    ...
    acmd!(lua_state, {
        if(is_excute){
            rust {
                ...
                if PUFFLEVELS[1][get_player_number(boma)] == 0 {
                    acmd!(lua_state, {
