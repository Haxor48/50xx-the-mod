...
#[acmd_script(agent = "plizardon", scripts = ["game_attackairlw"], category = ACMD_GAME)]
fn zard_dair(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=1)
...
#[acmd_script(agent = "plizardon", scripts = ["game_attacklw3"], category = ACMD_GAME)]
fn zard_dtilt(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=1)
...
fn zard_jab1(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    ...
    acmd!(lua_state, {
        frame(Frame=4)
        if(is_excute){
            ATTACK(ID=0, Part=0, Bone=hash40("top"), Damage=2.5, Angle=361, KBG=30, FKB=0, BKB=20, Size=2.4, X=0.0, Y=8.0, Z=4.0, X2=LUA_VOID, Y2=LUA_VOID, Z2=LUA_VOID, Hitlag=1.4, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_ON, FacingRestrict=ATTACK_LR_CHECK_F, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_purple"), SFXLevel=ATTACK_SOUND_LEVEL_S, SFXType=COLLISION_SOUND_ATTR_CUTUP, Type=ATTACK_REGION_PUNCH)
...
#[acmd_script(agent = "plizardon", scripts = ["game_attack12"], category = ACMD_GAME)]
fn zard_jab2(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=3)
        if(is_excute){
...
#[acmd_script(agent = "plizardon", scripts = ["game_specialairs"], category = ACMD_GAME)]
fn zard_sideb_air(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        if(is_excute){
...
#[acmd_script(agent = "plizardon", scripts = ["game_specialhi", "game_specialairhi"], category = ACMD_GAME)]
fn zard_upb(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=4)
        if(is_excute){
...
#[acmd_script(agent = "plizardon", scripts = ["game_attackdash"], category = ACMD_GAME)]
fn zard_da(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=10)
        if(is_excute){
...
#[acmd_script(agent = "plizardon", scripts = ["game_attacks4s"], category = ACMD_GAME)]
fn zard_fsmash(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=16)
        if(is_excute){
        ...
        if(is_excute){
            rust {
                if !AttackModule::is_infliction_status(module_accessor, *COLLISION_KIND_MASK_HIT) {
                    acmd!({
                        ATTACK(ID=0, Part=0, Bone=hash40("trans"), Damage=18.0, Angle=45, KBG=92, FKB=0, BKB=60, Size=6.0, X=0.0, Y=5.0, Z=14.0, X2=0.0, Y2=5.0, Z2=8.5, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_ON, FacingRestrict=ATTACK_LR_CHECK_POS, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_normal"), SFXLevel=ATTACK_SOUND_LEVEL_L, SFXType=COLLISION_SOUND_ATTR_KICK, Type=ATTACK_REGION_HEAD)
                        ATTACK(ID=1, Part=0, Bone=hash40("trans"), Damage=19.0, Angle=45, KBG=97, FKB=0, BKB=60, Size=5.0, X=0.0, Y=5.0, Z=14.0, X2=0.0, Y2=5.0, Z2=-3.0, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_ON, FacingRestrict=ATTACK_LR_CHECK_POS, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_fire"), SFXLevel=ATTACK_SOUND_LEVEL_L, SFXType=COLLISION_SOUND_ATTR_KICK, Type=ATTACK_REGION_HEAD)
                    });
                }
            }
        }
...
#[acmd_script(agent = "plizardon", scripts = ["game_attackhi4"], category = ACMD_GAME)]
fn zard_usmash(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=3)
        if(is_excute){
...
#[acmd_script(agent = "plizardon", scripts = ["game_attacklw4"], category = ACMD_GAME)]
fn zard_dsmash(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=2)
        if(is_excute){
...
#[acmd_script(agent = "plizardon", scripts = ["game_attackairb"], category = ACMD_GAME)]
fn zard_bair(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=4)
        if(is_excute){
        ...
        frame(Frame=14)
        if(is_excute){
            ATTACK(ID=1, Part=1, Bone=hash40("top"), Damage=14.0, Angle=361, KBG=100, FKB=0, BKB=50, Size=4.0, X=0.0, Y=3.2, Z=-17.5, X2=0.0, Y2=3.2, Z2=-17.5, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_ON, FacingRestrict=ATTACK_LR_CHECK_POS, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_purple"), SFXLevel=ATTACK_SOUND_LEVEL_L, SFXType=COLLISION_SOUND_ATTR_KICK, Type=ATTACK_REGION_TAIL)
            ATTACK(ID=2, Part=1, Bone=hash40("top"), Damage=11.0, Angle=361, KBG=100, FKB=0, BKB=50, Size=3.5, X=0.0, Y=5.0, Z=-7.0, X2=0.0, Y2=5.0, Z2=-13.0, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_ON, FacingRestrict=ATTACK_LR_CHECK_POS, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_purple"), SFXLevel=ATTACK_SOUND_LEVEL_M, SFXType=COLLISION_SOUND_ATTR_KICK, Type=ATTACK_REGION_TAIL)
        }
        wait(Frames=1)
        if(is_excute){
            rust {
                if !AttackModule::is_infliction_status(module_accessor, *COLLISION_KIND_MASK_HIT) {
                    acmd!(lua_state, {
                        ...
                        ATTACK(ID=2, Part=1, Bone=hash40("tail3"), Damage=11.0, Angle=361, KBG=100, FKB=0, BKB=50, Size=4.0, X=0.0, Y=-1.0, Z=0.0, X2=0.0, Y2=-2.0, Z2=-1.0, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_ON, FacingRestrict=ATTACK_LR_CHECK_POS, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_purple"), SFXLevel=ATTACK_SOUND_LEVEL_M, SFXType=COLLISION_SOUND_ATTR_KICK, Type=ATTACK_REGION_TAIL)
            ...
            rust {
                if !AttackModule::is_infliction_status(module_accessor, *COLLISION_KIND_MASK_HIT) {
                    acmd!(lua_state, {
                        ...
                        ATTACK(ID=2, Part=1, Bone=hash40("top"), Damage=11.0, Angle=361, KBG=100, FKB=0, BKB=50, Size=4.0, X=0.0, Y=14.5, Z=-13.2, X2=0.0, Y2=14.5, Z2=-9.5, Hitlag=1.0, SDI=1.0, Clang_Rebound=ATTACK_SETOFF_KIND_ON, FacingRestrict=ATTACK_LR_CHECK_POS, SetWeight=false, ShieldDamage=0, Trip=0.0, Rehit=0, Reflectable=false, Absorbable=false, Flinchless=false, DisableHitlag=false, Direct_Hitbox=true, Ground_or_Air=COLLISION_SITUATION_MASK_GA, Hitbits=COLLISION_CATEGORY_MASK_ALL, CollisionPart=COLLISION_PART_MASK_ALL, FriendlyFire=false, Effect=hash40("collision_attr_purple"), SFXLevel=ATTACK_SOUND_LEVEL_M, SFXType=COLLISION_SOUND_ATTR_KICK, Type=ATTACK_REGION_TAIL)
...
#[acmd_script(agent = "plizardon", scripts = ["game_catch"], category = ACMD_GAME)]
fn zard_grab(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=7)
        if(is_excute){
...
#[acmd_script(agent = "plizardon", scripts = ["game_catchdash"], category = ACMD_GAME)]
fn zard_dashgrab(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=10)
        if(is_excute){
...
#[acmd_script(agent = "plizardon", scripts = ["game_catchturn"], category = ACMD_GAME)]
fn zard_pivotgrab(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=11)
        if(is_excute){
...
#[acmd_script(agent = "plizardon_explosion", scripts = ["game_start"], category = ACMD_GAME)]
fn zard_sideb_hit(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        if(is_excute){
...
#[acmd_script(agent = "plizardon_breath", scripts = ["game_move"], category = ACMD_GAME)]
fn zard_flamethrower(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        if(is_excute){
...
#[acmd_script(agent = "plizardon", scripts = ["game_attackairn"], category = ACMD_GAME)]
fn zard_nair(fighter: &mut smash::lua2cpp::L2CAgentBase) {
    let lua_state = fighter.lua_state_agent;
    acmd!(lua_state, {
        frame(Frame=4)
        if(is_excute){
